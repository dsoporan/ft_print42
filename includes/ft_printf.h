...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/05/05 15:00:03 by dsoporan          #+#    #+#             */
/*   Updated: 2017/05/05 16:52:02 by dsoporan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				is_mod(char c);
int				is_double_mod(char *inside, int *i);
int				validate_mod(char *inside);
void			process_specifiers2(char *inside, t_mod *data);
void			process_specifiers(char *inside, t_mod *data);
void			process_zero_mod(char *inside, t_mod *data);
